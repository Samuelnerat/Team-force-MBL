    ...
    <section className="flex flex-col xl:flex-row justify-between gap-8  mx-20  mt-20">
      <div className="hidden lg:block w-[48%] relative">
        <motion.div
          ...
          className="relative"
        >
          <Image className="h-auto max-w-full" src="https://res.cloudinary.com/du1fj63cs/image/upload/v1731337362/account-bg_s39n7f.png" alt="background color" width={500} height={500} />
        </motion.div>
        ...
        >
          <Image className="h-auto max-w-full" src="https://res.cloudinary.com/du1fj63cs/image/upload/v1731337413/lady_smiling_rqxdz5.png" alt="lady smiling" width={500} height={530} />
        </motion.div>
        ...
        >
          <Image className="h-auto max-w-full" src="https://res.cloudinary.com/du1fj63cs/image/upload/v1731337480/cube_qfaenh.png" alt="a cube" width={75} height={100} />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 1, repeat: Infinity, repeatType: 'loop' }} 
        >
          <Image className="h-auto max-w-full" src="https://res.cloudinary.com/du1fj63cs/image/upload/v1731337549/cone_xdilzs.png" alt="a cone" width={65} height={65} />
        </motion.div>
        ...
        >
          <Image className="h-auto max-w-full" src="https://res.cloudinary.com/du1fj63cs/image/upload/v1731337596/people_nrttae.png" alt="people in a group" width={200} height={57} />
        </motion.div>
      </div>
