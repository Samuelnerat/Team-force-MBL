...
const Form = () => {
  return (
    <section className="main-container mx-24">
      <form
      ...
      >
        <div className="relative flex flex-col gap-3 max-w-[600px] mx-auto items-center">
          ...
          <input
            name="name"
            type="text"
            className="bg-[#d5c5ee] rounded-full h-10 border-none outline-none w-96 p-2"
          ...
          <textarea
            name="message"
            className="bg-[#d5c5ee] rounded-xl h-32 border-none outline-none w-96 p-2"
